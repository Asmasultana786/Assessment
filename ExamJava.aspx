<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="ExamJava.aspx.cs" Inherits="ExamJava" %>

<asp:Content ID="Content1" ContentPlaceHolderID="title" Runat="Server">Java Exam
</asp:Content>
...
<li>Before Giving Exam you should See the <a href="SyllabusJava.aspx">Syllabus For Java</a>.</li><br />
